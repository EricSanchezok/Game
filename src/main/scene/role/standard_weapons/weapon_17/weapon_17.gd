...
const THUNDER_MAGIC_BULLET = preload("res://src/main/scene/role/standard_weapons/weapon_17/thunder_magic_bullet.tscn")
...
func add_bullet() -> void:
	for index in attributes["PROJ_COUNT"]:
		var instance = THUNDER_MAGIC_BULLET.instantiate()
